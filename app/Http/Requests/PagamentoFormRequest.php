...
class PagamentoFormRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'taxa'=>'min:2|max:4',
            'condicao'=>'required|max:15|min:5',
        ];
    }
    ...
    public function messages(){
        return [
            ...
            'condicao.required' => 'Condição obrigatória',
            'condicao.max' => 'Condição deve conter no máximo 15 caracteres',
            'condicao.min' => 'Condição deve conter no máximo 5 caracteres',
        ];
    }
}
